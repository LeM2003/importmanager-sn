...
2. Entrez la **quantité vendue** et le **nom du client**
3. Sélectionnez le **statut** : Payé ou En attente
4. Le stock est **automatiquement mis à jour**
5. Consultez l'**historique des ventes**

---

## 🗺️ Roadmap

### Version 3.0 (En Planification)
- [ ] **UX améliorée** : Remplacer les prompts par des formulaires modernes
- [ ] **Export PDF** des calculs et factures
- [ ] **Thème sombre** (mode nuit)
- [ ] **Multi-langues** : Français / Anglais / Wolof
- [ ] **Graphiques** : Visualisation des ventes et profits

### Version 4.0 (Backend Complet)
- [ ] **Backend API** avec FastAPI (Python)
...
- 🐍 [**Python SysAdmin Tools**](https://github.com/LeM2003/Python-SysAdmin-Tools) - Outils d'automatisation système
